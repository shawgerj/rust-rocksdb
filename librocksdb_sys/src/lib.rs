...
extern "C" {
    ...
    pub fn crocksdb_options_set_fail_on_write(options: *mut Options, v: bool);
    ...
    pub fn crocksdb_env_drop_unsynced_data(env: *mut DBEnv, err: *mut *mut c_char);
    pub fn crocksdb_env_reset_state(env: *mut DBEnv, err: *mut *mut c_char);
